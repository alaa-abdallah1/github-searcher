...
import {ExternalLink, SkeletonCard, ErrorMessage} from "@/components"

const GithubList = () => {
  const dispatch: AppDispatch = useDispatch()
  const {error, items, hasMore, perPage, isLoading, isFetchingMore} =
  ...
  if (!items.length)
    return (
      <p className={styles.noItemsCard}>
